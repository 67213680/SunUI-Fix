...
ns.auras_instances_debuffs = {
	first = {
		[930] = { --5.2雷霆王座
			[138349] = 4,	-- Static Wound (Tank stacks)
			[137371] = 4,	-- Thundering Throw (Tank stun)
			[138732] = 6,	-- Ionization (Heroic - Dispel)
			[137399] = 7,	-- Focused Lightning (Fixated - Kiting)
			[138006] = 5,	-- Electrified Waters (Pool)

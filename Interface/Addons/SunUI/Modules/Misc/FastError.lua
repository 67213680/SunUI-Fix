---- SETTING HERE ---- ---- ---- ---- ----
local nfont = "FONTS\\FRIZQT__.TTF" -- This is the font`s of all errors
local nfontsize = 18 -- This is Font Size
local nfontcolor = {1,1,1} -- This is Font color ({RED,GREEN,BLUE,ALPHA}, only values from 0 to 1), 1 is deff

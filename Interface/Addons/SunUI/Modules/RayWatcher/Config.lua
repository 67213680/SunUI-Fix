...
local playerbuff1 = {"BOTTOM", UIParent, "BOTTOM",-185, 245} --name = "玩家buff",
local targetdebuff1 = {"TOP", UIParent, "BOTTOM", 185, 330} --name = "目标debuff",
local playercd1 = {"BOTTOM", UIParent, "BOTTOM", -185, 325}  --name = "玩家技能CD",
...
local enbuff = {"BOTTOM", UIParent, "BOTTOM",-185, 280}  --name = "玩家饰品附魔触发buff",
